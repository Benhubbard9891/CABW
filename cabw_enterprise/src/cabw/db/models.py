...
class Zone(Base):
    ...
    hazard_type: Mapped[str | None] = mapped_column(String(50), nullable=True, default=None)
...
class Agent(Base):
    ...
    current_goal: Mapped[str | None] = mapped_column(String(255), nullable=True, default=None)
    properties: Mapped[dict[str, Any]] = mapped_column(JSON, default_factory=dict)
...
class SimulationEvent(Base):
    ...
    source_id: Mapped[UUID | None] = mapped_column(ForeignKey("agents.id"), nullable=True, default=None)
    target_id: Mapped[UUID | None] = mapped_column(ForeignKey("agents.id"), nullable=True, default=None)
...
class AgentAction(Base):
    ...
    target_id: Mapped[UUID | None] = mapped_column(ForeignKey("agents.id"), nullable=True, default=None)
    target_zone_id: Mapped[UUID | None] = mapped_column(ForeignKey("zones.id"), nullable=True, default=None)
    params: Mapped[dict[str, Any]] = mapped_column(JSON, default_factory=dict)
    outcome: Mapped[dict[str, Any] | None] = mapped_column(JSON, nullable=True, default=None)
