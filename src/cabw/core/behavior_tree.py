...
class RepeaterNode(DecoratorNode):
    ...
    def __init__(self, name: str = "", child: BTNode | None = None, count: int = 1):
        """Initialize repeater."""
...
class CooldownNode(DecoratorNode):
    ...
    def __init__(self, name: str = "", child: BTNode | None = None, cooldown: float = 5.0):
...
class BehaviorTree:
    ...
    def __init__(self, root: BTNode | None = None, owner_id: str = ""):
        """Initialize behavior tree."""
        self.root = root
        self.blackboard = Blackboard(owner_id)
        self.tick_count = 0
