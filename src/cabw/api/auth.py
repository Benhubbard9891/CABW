...
class APIAuthManager:
    ...
    def authenticate_user(self, username: str, password: str) -> Optional[APIPrincipal]:
    ...
    def verify_token(self, token: str) -> Optional[APIPrincipal]:
...
class WebSocketAuth:
    ...
    @staticmethod
    async def authenticate(websocket: WebSocket) -> Optional[APIPrincipal]:
