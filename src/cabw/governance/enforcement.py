...
class ActionBudget:
    ...
    def __init__(
        ...
        # Penalty callbacks
        self._on_denial: Optional[Callable[[Any, str], None]] = None
    ...
    def get_receipt(self, token_id: str) -> Optional[ExecutionReceipt]:
...
class ConstitutionalLayer:
    ...
    def __init__(self):
        ...
        # Violation handlers
        self._on_violation: Optional[Callable[[SecurityViolation], None]] = None
